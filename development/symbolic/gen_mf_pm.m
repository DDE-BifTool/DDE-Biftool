...
% @Id $Id: gen_mf_pm.m 168 2017-03-03 22:04:32Z jansieber $
%
clear
%% Define system
...
nl=sprintf('\n');
str=sprintf('function f = sys_rhs(xx,par)\n\n');
for i=1:n
   str=strcat(str,'f(',num2str(i),') = ',char(f(i)),';',nl);
end
str=strcat(str,nl,'end',nl);
