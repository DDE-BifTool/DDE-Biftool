...
%
% $Id: nmfm_mfderiv.m 169 2017-03-03 22:06:16Z jansieber $
%%
order=length(devs);
%% for constant delay and user-provided sys_mfderi, call sys_mfderi
if ~funcs.tp_del && ~isempty(funcs.sys_mfderi)
...
[y,y2,h]=nmfm_ftau_diff_sav(funcs,order,point,pdevs,factors,varargin{:});
end
