...
display(real(G1_2100v),'HH.1: The real part of G1_2100 is ');
% (HH.2) Re g1_1011(0).ne.0 ;
display(real(G1_1011v),'HH.2: The real part of G1_1011 is ');
% (HH.3) Re g2_1110(0) .ne.0 ;
display(real(G2_1110v),'HH.3: The real part of G2_1110 is ');
% (HH.4) Re g2_0021(0) .ne.0 ;
display(real(G2_0021v),'HH.4: The real part of G2_0021 is ');
%%
