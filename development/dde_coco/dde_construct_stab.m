...
% $Id: dde_construct_stab.m 345 2019-05-12 00:11:15Z jansieber $
%%
default={'id','','bd_stability',true};
...
fcn=pointtype_list('kind',pt.kind);
hopftrlabel={'HB','TR'};
...
prob=coco_add_event(prob, @evhan_SN_HB, stabdata, 'SP', pids{2}, 0);
prob=coco_add_event(prob, @evhan_SN_HB, stabdata, 'SP', pids{3}, 0);
prob=coco_add_event(prob, @evhan_SN_HB, stabdata, 'SP', pids{4}, 0);
...
%%
function [data, cseg, msg] = evhan_SN_HB(~, data, cseg, cmd, msg)
